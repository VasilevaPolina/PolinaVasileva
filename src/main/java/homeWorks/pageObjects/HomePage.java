...
public class HomePage {
    ...
    @Step("Verify that number of images on Home Page are 4 and they are displayed")
    ...
    @Step("Verify that number of texts under images on the Home Page are 4 and they are displayed")
